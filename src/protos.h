...
// rendershader
extern bool gl_extsupported(const char *extension);
extern bool gl_compileshaderprogram(GL_ShaderData *data);
extern void gl_destroyshaderprogram(GL_ShaderData *data);
extern void gl_selectshader(int num);
extern int gl_getuniformshader(GL_ShaderData *data, char *name);
extern void gl_setuniformshader(int location, float value);
extern void gl_destroyshadercontext();
extern void gl_initshader();
